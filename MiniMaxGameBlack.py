...
def main():
    ...
    if len(sys.argv) != 4:
        print("Usage: python3 MiniMaxGameBlack.py <input_file> <output_file> <depth>")
        sys.exit(1)
    ...
    # Call minimax for the midgame/endgame phase (Black’s turn)
    best_board, nodes_evaluated, estimate = minmax(board, depth)
